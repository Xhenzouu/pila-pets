                    ...
                    <?php if (!empty($residents)): ?>
                        ...
                        <?php foreach ($residents as $resident): ?>
                            <tr>
                                ...
                                <td>
                                    <strong>
                                        <?= esc($resident['first_name']) ?>
                                        <?= !empty($resident['middle_name']) ? esc(' '.$resident['middle_name']) : '' ?>
                                        <?= esc(' '.$resident['last_name']) ?>
                                    </strong>
                                </td>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url('residents/delete/' . $resident['id']) ?>"
                                       ...
                                       onclick="return confirm('Delete <?= esc($resident['first_name'] . ' ' . ($resident['middle_name'] ?? '') . ' ' . $resident['last_name'], 'js') ?>?');">
